...
sbatch --time=5 --mem=7G --cpus-per-task=10 --threads-per-core=1 --ntasks=2 --nodes=1 --constraint=moles --job-name='5_core_1M' ./pthread_dif_files.sh 5 ../random_text_1k.txt
